...
const ADMIN_PASSWORD = "New3ngland"; // SAME password as coas.tsx
...
export default function AdminCreateCOAPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setWitnessedBy("");
      setFile(null);
      (document.getElementById("coa-image-input") as HTMLInputElement | null)?.value = "";
    } catch (err: any) {
      console.error(err);
        ...
        {createdCoa && (
          ...
          >
            ...
            <p style={{ marginTop: "0.5rem" }}>
              View certificate:{" "}
              <a href={`/cert/${createdCoa.qr_id}`} target="_blank" rel="noreferrer">
